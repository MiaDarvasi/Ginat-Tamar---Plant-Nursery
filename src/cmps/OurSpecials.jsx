            ...
            <section className="special-list">
                ...
                <div className="special-item">
                    ...
                    <section className="special-item-description">
                        ...
                        <p>במשתלה שלנו תמצאו בריכות צפרדעים קסומות. כשקר הן שקטות ורגועות, נהנות משנת החורף שלהן. אך בקיץ, כל הבריכה מתמלאת בקולות קירקורים מלאי חיים, והצפרדעים שוחות בין העלים וצבעי הבריכה, מוסיפות קסם טבעי ואווירה מיוחדת לכל פינה.</p>
                    </section>
                </div>
                <div className="special-item">
                    <Carousel responsive={responsive} infinite={true} className="skill-slider">
